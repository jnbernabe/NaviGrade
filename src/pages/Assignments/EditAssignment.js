      ...
      <Form onSubmit={handleSave}>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setAssignment({ ...assignment, weight: e.target.value })
            }
            step="0.01"
            min="0"
            max="1"
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setAssignment({ ...assignment, grade: e.target.value })
            }
            max="100"
          />
        </Form.Group>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setAssignment({ ...assignment, priority: e.target.value })
            }
            min="0"
            max="10"
          />
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setAssignment({ ...assignment, memo: e.target.value })
            }
          />
        </Form.Group>
